	...
	public function __get_categories_list() {
        ...
        <script>
            ...
            jQuery(document).ready(function ($) {
                $('#jet_ajax_search_categories_2f165d3').on('change', function () {
		...
		$category_string = '<select name="jet_ajax_search_categories" id="jet_ajax_search_categories_2f165d3" class="jet-ajax-search__categories-select">
		<option value="0" selected="selected">All Categories</option>';


		/*
		 * Custom Code to only Fetch specific
		 * Categories in Search Header
		 */
		$menus   = wp_get_nav_menu_items( 'special-menu' );
		$counter = 0;
		...
		foreach ( $menus as $menu_item ) {
			...
			if ( $parent_id == '0' ) {
				...
				$url             = $menu_item->url;
				$category_string .= '<option class="level-0"  data-url=' . $url . '> ' . $name . '</option>';
				$counter         += 1;
			}
		}
